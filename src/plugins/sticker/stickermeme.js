...
// // Gunakan font sistem yang pasti ada
// const FONT_FAMILY = process.platform === 'win32' 
//     ? 'Arial' 
//     : 'Sans';

// // Daftarkan font dengan try-catch
// try {
//     registerFont(path.join(path.join(process.cwd(), 'src','assets', 'fonts'), 'impact.ttf'), { family: 'Impact' });
// } catch (error) {
//     console.error('Error registering font:', error);
//     // Gunakan font fallback jika gagal
// }
