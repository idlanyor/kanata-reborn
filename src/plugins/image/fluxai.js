...
export default async ({ sock, m, id, psn, sender, noTel, caption }) => {
    ...
    try {
        ...
        const { url } = await fetch(`https://api.fasturl.link/aiimage/flux/model?prompt=${psn}&model=flux_1_schnell&size=1_1_HD&style=anime&color=vibrant&lighting=golden_hour&mode=image`);
