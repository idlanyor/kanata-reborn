...
export default async ({ sock, m, id, psn, sender, noTel, caption }) => {
    ...
    try {
        ...
        const { url } = await fetch(`https://api.fasturl.link/aiimage/flux/model?prompt=${psn}&model=flux_1_dev&size=1_1_HD&style=neon_punk&color=cool&lighting=dramatic&mode=image`);
