...
const URL = 'https://fastrestapis.fasturl.link/religious/prayerschedule?city=Purbalingga';
...
async function getPrayerImage(name) {
    const images = {
        'Sahur': 'https://fastrestapis.fasturl.link/file/v2/FieAa6x.jpg',
        'Imsyak': 'https://fastrestapis.fasturl.link/file/v2/wdGBB0L.jpg',
        'Shubuh': 'https://fastrestapis.fasturl.link/file/v2/J7r7Kzj.jpg',
        'Dzuhur': 'https://fastrestapis.fasturl.link/file/v2/Nm7xLET.jpg',
        'Ashar': 'https://fastrestapis.fasturl.link/file/v2/vl5k4iD.jpg',
        'Maghrib': 'https://fastrestapis.fasturl.link/file/v2/dATGtcL.jpg',
        'Buka': 'https://fastrestapis.fasturl.link/file/v2/NaP2lnd.jpg',
        'Isya': 'https://fastrestapis.fasturl.link/file/v2/pLwruV9.jpg',
        'Ramadhan': 'https://fastrestapis.fasturl.link/file/v2/sdb0OYA.jpg',
    };
    console.log(images[name]);
    return images[name] || 'https://fastrestapis.fasturl.link/file/v2/sdb0OYA.jpg';
}
