...
export async function tiktok(url) {
    try {
        let { data } = await axios.get('https://kanata.roidev.my.id/api/tiktok', {
            params: {
                url
            }
        })
...
export async function threadsDl(url) {
    try {
        let { data } = await axios.get('https://kanata.roidev.my.id/api/threads', {
            params: {
                url
            }
        })
...
export async function fb(url) {
    try {
        let { data } = await axios.get('https://kanata.roidev.my.id/api/facebook', {
            params: {
                url
            }
        })
...
export async function capcut(url) {
    try {
        let { data } = await axios.get('https://kanata.roidev.my.id/api/capcut', {
            params: {
                url
            }
        })
...
export async function ig(url) {
    try {
        let { data } = await axios.get('https://kanata.roidev.my.id/api/instagram', {
            params: {
                url
            }
        })
